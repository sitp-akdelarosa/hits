            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>（輸入）実入り倉庫届け時刻入力</b></td>
                ...
                <tr> 
                  <td width="15"> </td>
                    <td width="575">入力したい情報が多い場合、何度も入力するのは面倒です。<br>
                      ...
                      この「CSVファイル」を作成し転送を行う手順を以下に説明します。<br> &nbsp; </td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td width="15"> </td>
                    <td width="575"> 
                      <dl> 
                        <dt>（１）コンテナNo.単位の場合 
                        <dd>前述のアプリケーションを使って、コンテナNo.、届け時刻の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                        </dd>
                        <dd> 
                            ...
                            <tr> 
                              ...
                              <td> 
                                <table border="1" cellspacing="1" cellpadding="5">
                                  <tr> 
                                    <td bgcolor="#FFFFFF" nowrap>FYTU3546887, 
                                      2002/3/12/14/50<br>
                                      DTYU6778421, 2002/3/12/15/30<br>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                        ...
                        <dd> 
                          <table width="100" border="1" cellspacing="0" cellpadding="2" bgcolor="#FFFFFF">
                            ...
                            <tr valign="top"> 
                              ...
                              <td nowrap> 半角大文字英数字20桁以内</td>
                            </tr>
                            <tr valign="top"> 
                              <td nowrap>届け時刻<br>
                                （年月日時分）</td>
                              <td nowrap>2002/3/12/14/50 </td>
                              <td nowrap>・年：数字4桁<br>
                        ...
                        <dd><font color="#FF0033">【例】</font>C:\MyDocument内に abcdef.csv  というファイル名で保存します。
                          <p> 
                        <dt>（２）BL No．単位の場合 </dt>
                        <dd>コンテナNo.単位の場合と同様に、BL No．、届け時刻の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                        </dd>
                        <dd> 
                          <table border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              ...
                              <td> 
                                <table border="1" cellspacing="1" cellpadding="5">
                                  <tr> 
                                    <td bgcolor="#FFFFFF" nowrap>BL12549,2002/3/12/14/50<br>
                                      BL36722,2002/3/12/15/30<br>
                                    </td>
                                  </tr>
                                </table>
                              </td>
