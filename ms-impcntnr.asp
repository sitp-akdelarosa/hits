...
<%
    ...
    If strUserKind="海貨" Then
        ...
        Session.Contents("sortkey")="船名"           ' ソートキーを指定
    ...
    ' 輸入コンテナ照会
    WriteLog fs, iNum,"輸入コンテナ照会-" & strUserKind & "用照会","10", strOption
...
<%
    Else
        ' 一覧画面へリダイレクト
        If strUserKind="海貨" Then
            Response.Redirect "ms-implist1.asp"          '輸入コンテナ一覧
        ElseIf strUserKind="陸運" Then
            Response.Redirect "ms-implist2.asp"          '輸入コンテナ一覧
        ElseIf strUserKind="荷主" Then
            Response.Redirect "ms-implist1.asp"          '輸入コンテナ一覧
        End If
    End If
