...
'2016/01/14 Upd-S Fujiyama SQL Server 2014 対応
'        sql = "SELECT Booking.BookNo," &_
'					  "Booking.VslCode," &_
'					  "Booking.ShipLine," &_
'					  "mShipLine.FullName ShipLineName," &_
...
'					  "VslSchedule.VoyCtrl=*Booking.VoyCtrl"		'I20040223
        sql = "SELECT Booking.BookNo," &_
			  ...
			  "FROM Booking " &_
			  "LEFT JOIN Pickup " &_
				"ON Pickup.VslCode=Booking.VslCode " &_
				"AND Pickup.VoyCtrl=Booking.VoyCtrl " &_
				"AND Pickup.BookNo=Booking.BookNo " &_
			  "LEFT JOIN mShipLine " &_
				"ON mShipLine.ShipLine=Booking.ShipLine " &_
			  "LEFT JOIN mPort " &_
				"ON mPort.PortCode=Booking.DPort " &_
			  "LEFT JOIN mVessel " &_
				"ON mVessel.VslCode=Booking.VslCode " &_
			  "LEFT JOIN VslSchedule " &_
				"ON VslSchedule.VslCode=Booking.VslCode " &_
				"AND VslSchedule.VoyCtrl=Booking.VoyCtrl " &_
			  "WHERE (" & sWhere & ") "
'2016/01/14 Upd-E Fujiyama
'2006/03/06 add-s h.matsuda
...
'			strOut = strOut & "," & Trim(rsd("Material"))			'12:材質	'I20040223
			strOut = strOut & "," & Trim(rsd("Material")) & ","		'12:材質	'I20040223
			strOut = strOut & "," & DispDateTime(rsd("CYCut"),5) 		'14:CYカット日
'2008.01.12 NICS END
