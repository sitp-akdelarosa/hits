...
%>
		...
		<head>
			...
			<style>
				body {
					...
					color:#000000; 
					link:#3300FF; 
					background-image: url("gif/loginback.gif");
					leftmargin:0; 
					topmargin:0; 
					marginwidth:0; 
					marginheight:0;
		...
		<body onLoad="finit();">
			...
			<!-------------ここからログイン入力画面--------------------------->
			<table width="100%" style="border:0;" cellspacing="0" cellpadding="0" height=100%>
				<tr>
					<td valign=top>
						...
						<center>
							<!-- commented by seiko-denki 2003.07.17
									<table width=95% cellpadding="0" cellspacing="0" style="border:0;">
									<tr>
										<td align="right">
							...
							<table width="100%" style="border:0;" cellspacing="0" cellpadding="0">
								<tr>
									<td style="text-align:center; color:red;">
										...
										<br/>
										<br/>
										現在のHiTSアプリは「iOS11」へアップデートを行った場合、<br/>
										一部の動作において正常に動作しない現象が発生する可能性があります。
									</td>
								</tr>
							</table>
							<!-- 2016/10/11 H.Yoshikawa Add Start -->
							<table style="border:0;"><tr><td height=65></td></tr></table>
							
							<table style="border:0;" cellspacing="4" cellpadding="0" bgcolor="#ff9933">
								<tr>
									<td>
										<table style="border:0;" cellspacing="3" cellpadding="4" bgcolor="#ffffff">
											<tr>
												<td>
													<table width="500" style="border:0;" cellspacing="0" cellpadding="5" bgcolor="#FFFFCC">
														<tr>
															<td>
																<table width="100%">
																	<tr>
																				...
																				<tr>
																					<td nowrap style="text-align:center;">
																						<form name="usercheck" action="userchk.asp" method="put">
																							<input name="Screen_Mode" size="9" readonly tabindex= -1 type= hidden>
																							...
																							<center>
																								...
																								<input type="submit" value=" 送　信 " onClick="return Check()">
																							</center>
																						</form>
																					</td>
																				</tr>
																	...
																	<tr>
																		...
																		<%= "　操作しない状態が" & Session.Timeout & "分以上続くと自動的にログアウトします。<br> &nbsp;&nbsp;その場合、お手数ですが再度ログインのうえご利用ください。"%></Font></b></td-->
																		<td align="Left">
																			<b><font color="Blue"><%= "&nbsp;&nbsp;トップページに'ログイン中'が表示されていてもタイムアウト<br>&nbsp;&nbsp;(約" & Session.Timeout & "分）により本画面が表示される可能性があります。"%></font></b>
																		</td>
																	...
																	<tr>
																		<td><img src="gif/bo-yellow.gif" width="18" height="18"></td>
																		<td align="right">
																			<img src="gif/1.gif" width=1 height=1>
																			<a href="javascript:OpenWindow()">
																				<font size=2 color="#0000ff">利用者情報の更新</font>
																			</a>
																		</td>
																		<td><img src="gif/bo-yellow.gif" width="18" height="18"></td>
																		<!-- </td> -->
						...
						<!-- 2017/09/06 Mw.Tanaka Add-S -->
						<center>
							<div style="margin-top:20px;padding:20px;border:solid 2px #FF0000;width:550px;text-align:center;">
								<font color="#ff0000">※ 会社コード・パスワード等の重要情報の取扱には十分ご注意下さい。</font>
							</div>
						</center>
						<!-- 2017/09/06 Mw.Tanaka Add-E -->
					</td>
				</tr>
