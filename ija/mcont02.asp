...
If vFlg="1" Then
	If sErrMsg<>"" Then
		WriteLogM oFS, "Unknown", "2201", "携帯-コンテナ番号照会", "10",sPhoneType, Ucase(vCtnoE) & "/" & vCtnoS & "," & "入力内容の正誤:1(誤り)" & sErrMsg
	Else
		WriteLogM oFS, "Unknown", "2201", "携帯-コンテナ番号照会", "10",sPhoneType, Ucase(vCtnoE) & "/" & vCtnoS & "," & "入力内容の正誤:0(正しい)"
		WriteLogM oFS, "Unknown", "2202", "携帯-コンテナ詳細", "00",sPhoneType, CntNo & ","
	End If
Else
	WriteLogM oFS, "Unknown", "2205", "携帯-コンテナ詳細(BL)", "00",sPhoneType, CntNo & ","
End If
Set oFS = Nothing
