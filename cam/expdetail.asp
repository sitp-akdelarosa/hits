...
<!-- mod by nics 2009.02.12 -->
<!--                    <td bgcolor="#FFCC33" nowrap>仕向港</td>-->
                    <td bgcolor="#FFCC33" nowrap>仕向港<font size="-1"><sup>(※3)</sup></font></td>
<!-- end of mod by nics 2009.02.12 -->
                  </tr>
                  <tr align="center" bgcolor="#FFFF99">
<!-- commented by nics 2009.02.12
...
<!-- add by nics 2009.02.12 -->
                    <td rowspan="4" align="center"  bgcolor="#FFFFFF"><table border="0" cellspacing="5">
                      <tr>
                        <td nowrap><a href="javascript:Submit('Form1')" class="splink" onClick="javascript:winOpen('win1','./cct/index.asp',560,500)">&nbsp;赤湾&nbsp;</a></td>
<!-- mod-s by mes 2009/05.13 -->
<!--
                      <td nowrap><a href="#" class="dummylink" onClick="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
-->
	                    <td nowrap><a href="gaibuif/impcntnr.asp?cntnrno=<%Response.Write anyTmp(1)%>&portcode=HUANG" class="splink" onClick="">&nbsp;黄埔&nbsp;</a>
<!-- mod-e by mes 2009/05.13 -->
                        </td>
                      </tr>
                      <tr>
                        <td><a href="javascript:Submit('queryForm')" class="splink" onClick="javascript:winOpen('win1','./sct/index.asp',560,500)">&nbsp;蛇口&nbsp;</a></td>
<!-- mod-s by mes 2009/05.13 -->
<!--
                      <td nowrap><a href="#" class="dummylink" onClick="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
-->
	                    <td nowrap><a href="gaibuif/impcntnr.asp?cntnrno=<%Response.Write anyTmp(1)%>&portcode=NANSH" class="splink" onClick="">&nbsp;南沙&nbsp;</a></td>
<!-- mod-e by mes 2009/05.13 -->
                      </tr>
                      <tr>
	                    <td nowrap><a href="#" class="dummylink" onClick="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
...
<!-- end of mod by nics 2009.02.12 -->
              <tr> 
                <td width="15">&nbsp;</td>
<!-- mod by nics 2009.02.12 -->
<!--                <td nowrap><font color="#000000" size="-1">（※2）倉庫到着完了が指示時間より遅れたら赤色表示 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（※3）仕向港の時刻は、現地時間です。<br>
                  （※4）仕向港が枠内に表示されている場合、ボタンをクリックすると当該港での位置情報等が表示されます。</font></td>-->
                <td nowrap><font color="#000000" size="-1">（※3）ボタンをクリックすると当該港での位置情報等が表示されます（現地時間表示）。</font></td>
<!-- end of mod by nics 2009.02.12 -->
              </tr>
            </table>
<!-- commented by nics 2009.02.12
