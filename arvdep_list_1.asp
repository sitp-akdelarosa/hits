...
Response.Write "<input type='hidden' name='vessel' value='" & Trim(Request.Form("vessel")) & "'>" & CRLF
	...
	sql = sql & " WHERE DocNum IS NOT NULL AND (ShipPortSch='香椎４岸' or ShipPortSch='香椎５岸' or ShipPortSch='ＩＣ６岸' or ShipPortSch='中央４岸' or ShipPortSch='ＩＣ５岸' or ShipPortSch='ＩＣ７岸') "
