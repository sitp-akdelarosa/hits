      ...
      <table>
        <tr>
	     ...
	     <table>
          <tr>
	        <td nowrap>
                <center><font color="#000066" size="+1">【輸入コンテナ情報用ファイル転送画面】</font></center><br>
			入力したいコンテナ情報を含むCSVファイルを選択し、送信ボタンを
              クリック<br>して下さい。</td></tr>
		 </table>
			<form action="ms-kaika-impcontinfo-csvin.asp" enctype="multipart/form-data" method="post"> 
...
<%
    ...
    ' 海貸用ファイル転送画面照会
    WriteLog fs, "4111","海貨入力輸入コンテナ情報-CSVファイル転送","00", ","
%>
