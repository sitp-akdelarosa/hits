...
<% End If %>
  ...
  <TR>
	...
	<TABLE border=0 cellPadding=2 cellSpacing=0 width="100%">
	  <TR valign=top>
	    <TD>
	        <DIV class=bgb>*サイズ、タイプ、高さ、テアウェイト</DIV></TD>										<!-- 2016/08/08 H.Yoshikawa Upd (材質削除) -->
	  ...
	  <TR>
	    <TD><DIV class=bgb>*コンテナグロス（テア含む）</DIV></TD>											<!-- 2016/08/08 H.Yoshikawa Upd (グロスウェイト→コンテナグロス) -->
	  ...
	  <TR>
		<TD colspan=2 style="padding-top:0px;">
			...
			<INPUT type=checkbox <% if gfTrim(Request("SolasChk")) = "1" then %>checked<% end if %> disabled>ここに入力したコンテナグロスはSOLAS条約に基づく方法で計測された数値です。
		</TD>
	  </TR>
	  <TR>
	    <TD><DIV class=bgb>届出番号または登録番号</DIV></TD>
	    <TD><INPUT type=text name="ReportNo" value="<%=Request("ReportNo")%>" size=35 ></TD></TR>
	  <TR>
	  ...
	  <TR>
	    ...
	    <TD><INPUT type=text name="VENT" value="<%=Request("VENT")%>" size=5>&nbsp;%（開口）</TD></TR>
	  <TR>
	  ...
	  <TR><TD colspan=2>
	  	<TABLE cellpadding=1 cellspacing=0><TR>
		    ...
		    <TD><INPUT type=text name="OH"  value="<%=Request("OH")%>"  size=5 ></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/WL</DIV></TD>
		    <TD><INPUT type=text name="OWL" value="<%=Request("OWL")%>" size=5 ></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/WR</DIV></TD>
		    <TD><INPUT type=text name="OWR" value="<%=Request("OWR")%>" size=5 ></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/LF</DIV></TD>
		    <TD><INPUT type=text name="OLF" value="<%=Request("OLF")%>" size=5 ></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/LA</DIV></TD>
		    <TD><INPUT type=text name="OLA" value="<%=Request("OLA")%>" size=5 >&nbsp;cm</TD>
		</TR></TABLE>
	  </TD></TR>
	  <TR>
