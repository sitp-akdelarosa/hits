            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>輸入コンテナ照会結果出力（陸運用）</b></td>
                          ...
                          <tr> 
                            ...
                            <td> 
                              <table border="1" cellspacing="1" cellpadding="5">
                                <tr> 
                                  <td bgcolor="#FFFFFF" nowrap>海貨,BL No.,コンテナNo.,倉庫略称, 
                                    仕出港離岸完了時刻,前港離岸完了時刻<br>
                                    大山海運株式会社,BL12546, FYTU2234567, 松山, 2002/12/20 
                                    12:00, 2002/12/24 2:20<br>
                                    株式会社犬塚高速,BL46772,HJLU9882773, 大倉, 2002/12/20 
                                    12:00, 2002/12/24 2:20<br>
                                    <br>
                                  </td>
                                </tr>
                    ...
                    <dl> 
                      ...
                      <dd> 
                        <table border="1" cellspacing="1" cellpadding="5" width=500>
                          <tr> 
                            <td bgcolor="#FFFFFF">海貨, BL No., コンテナNo., 倉庫略称, 仕出港離岸完了時刻, 
                              前港離岸完了時刻, CY着岸計画, CY着岸予定時刻, CY着岸完了時刻, CY搬入完了時刻, 
                              CY搬出完了時刻, SY予約時刻, SY搬出完了時刻, 倉庫到着指示時刻, 倉庫到着完了時刻, 
                              デバン完了時刻, 空コン返却時刻, 搬入確認予定時刻, 搬入確認完了時刻, 動植物検疫, 個別搬入, 
                              通関/保税輸送, DO発行, フリータイム, 搬出可否, サイズ, 高さ, リーファー, 総重量, 
                              危険物, 搬出ターミナル名, ストックヤード利用, 返却先, 船社, 船名, VoyageNo., 
                              仕出港, 前港 </td>
                          </tr>
                        </table>
                        <br>
