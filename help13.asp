            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b><font color="#000000">輸出コンテナ照会結果出力（海貨用）</font></b></td>
                          ...
                          <tr> 
                            ...
                            <td> 
                              <table border="1" cellspacing="1" cellpadding="5">
                                <tr> 
                                  <td bgcolor="#FFFFFF" nowrap>荷主,荷主管理番号,Booking 
                                    No.,コンテナNo.,指定陸運業者, 倉庫略称, 空コン受取場所, サイズ<br>
                                    松山電機販売,6789223,ABS544423, FYTU3546887,富山運送株式会社, 
                                    松山A,香椎VP, 20<br>
                                    松山電機販売,6789223,ABS544423, KYAU8981726,ハザマ株式会社, 
                                    松山B,香椎VP, 40<br>
                                    <br>
                                    <br>
                                  </td>
                          ...
                          <td> 
                              ...
                              <table border="1" bgcolor="#FFFFFF" >
                                <tr valign="top"> 
                                  ...
                                  <td>指定陸運業者</td>
                                  <td nowrap>倉庫略称</td>
                                  <td nowrap>空コン<br>受取場所</td>
                                  <td nowrap>サイズ</td>
                                </tr>
                                <tr valign="top"> 
                                  <td nowrap>松山電機販売</td>
                                  <td nowrap>6789223</td>
                                  <td nowrap>ABS544423</td>
                                  <td nowrap> FYTU3546887</td>
                                  <td nowrap>富山運送株式会社</td>
                                  <td>松山A </td>
                                  <td> 香椎VP</td>
                                  <td> 20</td>
                                </tr>
                    ...
                    <dl> 
                      ...
                      <dd> 
                        <table border="1" cellspacing="1" cellpadding="5" width=500>
                          <tr> 
                            <td bgcolor="#FFFFFF">荷主, 荷主管理番号,Booking No., コンテナNo., 
                              指定陸運業者, 倉庫略称, 空コン受取場所, サイズ, 高さ, リーファー, シールNo., 貨物重量, 
                              総重量, 搬入ターミナル名, CYオープン日, CYクローズ日, 空コン受取完了時刻, 倉庫到着指示時刻, 
