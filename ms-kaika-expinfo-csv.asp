      ...
      <table>
        <tr>
	     ...
	     <table>
          <tr>
	        <td nowrap>
                <center><font color="#000066" size="+1">【輸出貨物情報用ファイル転送画面】</font></center><BR>
			入力したいコンテナ情報を含むCSVファイルを選択し、送信ボタンを<BR>
              クリックして下さい。</td></tr>
		 </table>
			<form action="ms-kaika-expinfo-csvin.asp" enctype="multipart/form-data" method="post"> 
...
<%
    ...
    ' 海貸用ファイル転送画面照会
    WriteLog fs, "4103","海貨入力輸出貨物情報-CSVファイル転送","00", ","
%>
