                              ...
                              <table border="1" cellspacing="1" cellpadding="5">
                                <tr> 
                                  <td bgcolor="#FFFFFF" nowrap>
									Booking No.,船社,船名,Voyage No.,仕向港,空コン搬出場所,CYカット,サイズ,タイプ<br>
                                    ABS544423, ABCDE LINE, WAN CHAN 211, 12345, HONGKONG, 香椎VP,12/10, 20, RF<br>
                                    ABS544423, ABCDE LINE, WAN CHAN 211, 12345, PARIS, 香椎VP,12/10, 40, DG<br>
                                    <br>
                                    <br>
                                  </td>
                                </tr>
                    ...
                    <dl> 
                      ...
                      <dd> 
                        <table border="1" cellspacing="1" cellpadding="5" width=500>
                          <tr> 
                            <td bgcolor="#FFFFFF">
								Booking No., 船社, 船名, VoyageNo., 仕向港, 空コン搬出場所, CYカット, 
								サイズ, タイプ, 高さ, 予約本数, 搬出済本数
							</td>
                          </tr>
                        </table><br>
