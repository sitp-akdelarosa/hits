  ...
  <TR>
	...
	<!-- 2016/08/08 H.Yoshikawa Add Start -->
	  ...
	  <!-- 2017/05/08 H.Yoshikawa Del Start
    	...
    	<TD> -->
    	  <INPUT type=hidden name="EntryName" value="<%=Request("EntryName")%>" >  <!-- 2017/05/08 H.Yoshikawa Upd（text ⇒ hidden）-->
      <!-- 
...
<!-- 2016/08/18 H.Yoshikawa Add-S -->
	...
	<TABLE border=0 cellPadding=2 cellSpacing=0 width="100%">
	  ...
	  <TR>
	    ...
	    <TD><INPUT type=text name="DefName" value="<%=gfHTMLEncode(DefName)%>" size=40></TD></TR>
	  <!-- 2017/04/04 H.Yoshikawa Add End -->
	  <!-- <TR>
