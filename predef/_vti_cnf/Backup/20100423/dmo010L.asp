...
'  DtTbl(0)=Array("搬出先","搬出<BR>予定日","指示元","作業<BR>番号","指定種類","コンテナ番号<BR>／ＢＬ番号","完了日時","返却予定","返却","指示先","指示先<BR>回答","BL番号","アラームフラグ","照会先","指示元へ回答","船社","船名","サイズ","ＣＹ","フリー<BR>タイム","搬出完了日","返却値","備考１","備考２","納入先１")
  DtTbl(0)=Array("搬出先","搬出<BR>予定日","指示元","作業<BR>番号","指定種類","コンテナ番号<BR>／ＢＬ番号","完了日時","返却予定","返却","指示先","指示先<BR>回答","BL番号","アラームフラグ","照会先","指示元へ回答","船社","船名","SZ","ＣＹ","フリー<BR>タイム","搬出完了日","返却値","備考１","備考２","納入先１","コード","担当")
'Chang 20050303 END
'2009/02/25 Add-S G.Ariola
dim ctr
for ctr = 1 to 3
...
<%If Num>0 Then%> 
  ...
  <tr>
    ...
    <TH class="hlist" nowrap>指示元<BR>へ回答</TH>
