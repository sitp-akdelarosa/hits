...
'2009/02/25 Del-E G.Ariola  
      ...
      StrSQL = StrSQL & "FROM BookingAssign AS SPB LEFT JOIN mUsers AS mU ON SPB.SenderCode = mU.UserCode "
               '"LEFT JOIN ViewBookAssing AS VBA ON SPB.BookNO=VBA.BookNo "&_
			   
	  StrSQL = StrSQL & "LEFT JOIN ExportCont AS EXC ON EXC.bookno=SPB.bookno "&_
