...
//2016/08/22 H.Yoshikawa Upd Start
  ...
  window.resizeTo(1200,820);			// 2017/05/09 H.Yoshikawa Upd(770⇒820)
...
<TABLE border=0 cellPadding=3 cellSpacing=0 width="100%">
  ...
  <TR>
    <TD colspan=2>
    <TABLE border=0 cellPadding=0 cellSpacing=0 width=980 align=center>				<!-- 2017/05/10 H.Yoshikawa Upd(width:920⇒980) -->
