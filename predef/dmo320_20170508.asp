	...
	<TABLE border=0 cellPadding=2 cellSpacing=0 width="100%">
	  ...
	  <TABLE>
		  <TR>
		    ...
		    <TD></TD></TR>
		  <TR>
		    <TD><DIV class=bgb>コンテナ総重量</DIV></TD>
		    <TD><INPUT type=text name="GrosW" value="<%=Trim(ObjRS("ContWeight"))%>" size=9>&nbsp;kg</TD></TR>			<!-- 2017/04/20 H.Yoshikawa Upd(size=5→9) -->
		  <TR>
		    <TD><DIV class=bgb>テアウェイト</DIV></TD>
		    <TD><INPUT type=text name="CONtear" value="<%=Trim(ObjRS("TareWeight"))%>" size=9>&nbsp;kg</TD></TR>		<!-- 2017/04/20 H.Yoshikawa Upd(size=7→9) -->
		  ...
		  <TR>
		    ...
		    <TD><INPUT type=text name="ReportNo" value="<%=gfTrim(ObjRS("ReportNo"))%>" size=17 maxlength=12 >　<span style="color:red">※ハイフンなしで入力してください</span></TD></TR>
		  <!-- 2016/08/08 H.Yoshikawa Add End -->
		  <!-- 2017/04/04 H.Yoshikawa Add Start -->
		  <TR>
		    <TD><DIV class=bgb>重量　確定事業者</DIV></TD>
		    <TD><INPUT type=text name="DefName" value="<%=gfTrim(ObjRS("DefName"))%>" size=40></TD></TR>
