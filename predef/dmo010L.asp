...
<%If Num2<>0 Then%>
	...
	{
		if((document.body.offsetWidth-200) < 880) {
			obj3.style.width=document.body.offsetWidth-70; // Edited by AK.DELAROSA 2021/01/11
			obj3.style.overflowX="auto";
		}
		else{
			<% If DtTbl(0)(14)<>0 Then %>
		...
		//Y.TAKAKUWA Upd-S 2015-03-09 Edited by AK.DELAROSA 2021/01/11
		var height = 0;
		...
		//Y.TAKAKUWA Upd-E 2015-03-09 Edited by AK.DELAROSA 2021/01/11
	}
	else{
	...
	{
		if((document.body.offsetWidth-200) < 880) {
			obj3header.style.width=document.body.offsetWidth-87; // Edited by AK.DELAROSA 2021/01/11
		}
		else{
			<% If DtTbl(0)(14)<>0 Then %>
		...
		obj3header.style.height = 51; //35;  // Edited by AK.DELAROSA 2021/01/11
	}
	else
	{
		if((document.body.offsetWidth-200) < 880) {
