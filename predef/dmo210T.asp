...
<TABLE border=0 cellPadding=3 cellSpacing=0 width="100%">
  <FORM name="serch" action="">
   <TR><TD width="60%"><B class=title>空バンピック作業一覧</B><BR><BR>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type=button style="WIDTH: 120px;" value="空搬出データ更新" OnClick="parent.parent.Top.location.reload(true);sort();">
