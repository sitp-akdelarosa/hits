...
<TD valign="top">
	...
	<% If Mord<>"0" Then %>
	      <TABLE border=1 cellPadding=3 cellSpacing=0 align="right">
	          <TR bgcolor="#f0f0f0"><TD nowrap>作業番号</TD><TD nowrap><%=SakuNo%></TD></TR>
	      </TABLE>
	<% End If %>
	    </TD></TR>
	</TABLE>
	<TABLE border=0 cellPadding=2 cellSpacing=0>
	  <TR>
	    <TD width="90px"><DIV class=bgb>コンテナＮｏ．</DIV></TD>
	...
	<!-- 2016/08/01 H.Yoshikawa Add Start -->
	  ...
	  <TR><TD colspan=2>
	  	...
	  	<TR><TD><DIV class=bgb>*取扱海貨社名<BR>*（担当者）<BR>*（連絡先）</DIV></TD>
			<TD><INPUT type=text name="Forwarder" value="<%=Request("Forwarder")%>" style="margin-bottom:2px;" maxlength=80 size=40><BR>
	    		<INPUT type=text name="FwdStaff" value="<%=Request("FwdStaff")%>" maxlength=20><BR>
...
<BR>
	<TABLE border=0 cellPadding=2 cellSpacing=0>
	  ...
	  <TR>
	    <TD style="padding-bottom:0px;"><DIV class=bgb>*コンテナグロス（テア含む）</DIV></TD>
	    <TD style="padding-bottom:0px;"><INPUT type=text name="GrosW" value="<%=Request("GrosW")%>" size=9 maxlength=8>&nbsp;kg</TD>
	  </TR>
	  <TR>
		<TD colspan=2 style="padding-top:0px;"><INPUT type=checkbox name="SolasChk" value="1" <% if gfTrim(Request("SolasChk")) = "1" then %>checked<% end if %>>ここに入力したコンテナグロスはSOLAS条約に基づく方法で計測された数値です。</TD>
	  </TR>
	  <TR>
	    <TD><DIV class=bgb>届出番号または登録番号</DIV></TD>
	    <TD><INPUT type=text name="ReportNo" value="<%=Request("ReportNo")%>" size=25 maxlength=20 title="荷送人の届出番号、または
登録確定事業者番号を入力してください。"></TD></TR>
	  <TR>
	  ...
	  <!-- 2016/08/01 H.Yoshikawa Add End -->
	  <TR>
	    <TD style="padding-top:0px;"><DIV class=bgb>ＵＮ Ｎｏ.&nbsp;1～5</DIV></TD>
	    <TD style="padding-top:0px;">
	        <TABLE cellpadding=0 cellspacing=0><TR>
	  ...
	  <TR><TD colspan=2>
	  	<TABLE cellpadding=1 cellspacing=0><TR>
		    ...
		    <TD><INPUT type=text name="OH"  value="<%=Request("OH")%>"  size=5 maxlength=7></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/WL</DIV></TD>
		    <TD><INPUT type=text name="OWL" value="<%=Request("OWL")%>" size=5 maxlength=7></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/WR</DIV></TD>
		    <TD><INPUT type=text name="OWR" value="<%=Request("OWR")%>" size=5 maxlength=7></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/LF</DIV></TD>
		    <TD><INPUT type=text name="OLF" value="<%=Request("OLF")%>" size=5 maxlength=7></TD>
		    <TD width="10px"></TD>
		    <TD width="40px"><DIV class=bgb>O/LA</DIV></TD>
		    <TD><INPUT type=text name="OLA" value="<%=Request("OLA")%>" size=5 maxlength=7>&nbsp;cm</TD>
		</TR></TABLE>
	  </TD></TR>
	  <TR>
