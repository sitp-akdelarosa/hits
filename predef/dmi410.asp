...
<TABLE border="0" cellPadding="5" cellSpacing="0" width="100%">
	...
	<TR>
		...
		<% if Request.Form("Email1") <> "" then %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email1" name="Email1" value="<%=Request.Form("Email1")%>" size="70" maxlength="100"></TD>
		<% else %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email1" name="Email1" value="<%=Email1%>" size="70" maxlength="100"></TD>
		<% end if %>
		
		<% if F_DelResults(0) = "1" or Request.Form("F_DelResults1") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelResults1" name="DelResults1" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelResults1" name="DelResults1"></TD>
		<% end if %>
		
		<% if F_RecEmp(0) = "1" or Request.Form("F_RecEmp1") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecEmp1" name="RecEmp1" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecEmp1" name="RecEmp1"></TD>
		<% end if %>

		<% if F_RecResults(0) = "1" or Request.Form("F_RecResults1") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecResults1" name="RecResults1" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecResults1" name="RecResults1"></TD>
		<% end if %>

		<% if F_DelEmp(0) = "1" or Request.Form("F_DelEmp1") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelEmp1" name="DelEmp1" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelEmp1" name="DelEmp1"></TD>
		<% end if %>
	...
	<TR>
		...
		<% if Request.Form("Email2") <> "" then %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email2" name="Email2" value="<%=Request.Form("Email2")%>" size="70" maxlength="100"></TD>
		<% else %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email2" name="Email2" value="<%=Email2%>" size="70" maxlength="100"></TD>
		<% end if %>
		
		<% if F_DelResults(1) = "1" or Request.Form("F_DelResults2") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelResults2" name="DelResults2" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelResults2" name="DelResults2"></TD>
		<% end if %>
		
		<% if F_RecEmp(1) = "1" or Request.Form("F_RecEmp2") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecEmp2" name="RecEmp2" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecEmp2" name="RecEmp2"></TD>
		<% end if %>

		<% if F_RecResults(1) = "1" or Request.Form("F_RecResults2") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecResults2" name="RecResults2" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecResults2" name="RecResults2"></TD>
		<% end if %>

		<% if F_DelEmp(1) = "1" or Request.Form("F_DelEmp2") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelEmp2" name="DelEmp2" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelEmp2" name="DelEmp2"></TD>
		<% end if %>
	...
	<TR>
		...
		<% if Request.Form("Email3") <> "" then %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email3" name="Email3" value="<%=Request.Form("Email3")%>" size="70" maxlength="100"></TD>
		<% else %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email3" name="Email3" value="<%=Email3%>" size="70" maxlength="100"></TD>
		<% end if %>
		
		<% if F_DelResults(2) = "1" or Request.Form("F_DelResults3") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelResults3" name="DelResults3" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelResults3" name="DelResults3"></TD>
		<% end if %>
		
		<% if F_RecEmp(2) = "1" or Request.Form("F_RecEmp3") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecEmp3" name="RecEmp3" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecEmp3" name="RecEmp3"></TD>
		<% end if %>

		<% if F_RecResults(2) = "1" or Request.Form("F_RecResults3") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecResults3" name="RecResults3" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecResults3" name="RecResults3"></TD>
		<% end if %>

		<% if F_DelEmp(2) = "1" or Request.Form("F_DelEmp3") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelEmp3" name="DelEmp3" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelEmp3" name="DelEmp3"></TD>
		<% end if %>
	...
	<TR>
		...
		<% if Request.Form("Email4") <> "" then %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email4" name="Email4" value="<%=Request.Form("Email4")%>" size="70" maxlength="100"></TD>
		<% else %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email4" name="Email4" value="<%=Email4%>" size="70" maxlength="100"></TD>
		<% end if %>
		
		<% if F_DelResults(3) = "1" or Request.Form("F_DelResults4") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelResults4" name="DelResults4" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelResults4" name="DelResults4"></TD>
		<% end if %>
		
		<% if F_RecEmp(3) = "1" or Request.Form("F_RecEmp4") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecEmp4" name="RecEmp4" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecEmp4" name="RecEmp4"></TD>
		<% end if %>

		<% if F_RecResults(3) = "1" or Request.Form("F_RecResults4") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecResults4" name="RecResults4" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecResults4" name="RecResults4"></TD>
		<% end if %>

		<% if F_DelEmp(3) = "1" or Request.Form("F_DelEmp4") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelEmp4" name="DelEmp4" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelEmp4" name="DelEmp4"></TD>
		<% end if %>
	...
	<TR>
		...
		<% if Request.Form("Email5") <> "" then %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email5" name="Email5" value="<%=Request.Form("Email5")%>" size="70" maxlength="100"></TD>
		<% else %>
				<TD width="5%" colspan="3">　　<input type="text" id="Email5" name="Email5" value="<%=Email5%>" size="70" maxlength="100"></TD>
		<% end if %>
		
		<% if F_DelResults(4) = "1" or Request.Form("F_DelResults5") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelResults5" name="DelResults5" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelResults5" name="DelResults5"></TD>
		<% end if %>
		
		<% if F_RecEmp(4) = "1" or Request.Form("F_RecEmp5") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecEmp5" name="RecEmp5" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecEmp5" name="RecEmp5"></TD>
		<% end if %>

		<% if F_RecResults(4) = "1" or Request.Form("F_RecResults5") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="RecResults5" name="RecResults5" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="RecResults5" name="RecResults5"></TD>
		<% end if %>

		<% if F_DelEmp(4) = "1" or Request.Form("F_DelEmp5") = "1" then %>
				<TD width="1%" colspan="1"><input type="checkbox" value="1" id="DelEmp5" name="DelEmp5" checked></TD>
		<% else %>
				<TD width="1%" colspan="1"><input type="checkbox" value="0" id="DelEmp5" name="DelEmp5"></TD>
		<% end if %>
	...
	<TR>
		<TD colspan="5" align="center">
			<INPUT type="hidden" id="F_DelResults1" name="F_DelResults1" value="">
			<INPUT type="hidden" id="F_DelResults2" name="F_DelResults2" value="">
			<INPUT type="hidden" id="F_DelResults3" name="F_DelResults3" value="">
			<INPUT type="hidden" id="F_DelResults4" name="F_DelResults4" value="">
			<INPUT type="hidden" id="F_DelResults5" name="F_DelResults5" value="">
			<INPUT type="hidden" id="F_RecEmp1" name="F_RecEmp1" value="">
			<INPUT type="hidden" id="F_RecEmp2" name="F_RecEmp2" value="">
			<INPUT type="hidden" id="F_RecEmp3" name="F_RecEmp3" value="">
			<INPUT type="hidden" id="F_RecEmp4" name="F_RecEmp4" value="">
			<INPUT type="hidden" id="F_RecEmp5" name="F_RecEmp5" value="">
			<INPUT type="hidden" id="F_RecResults1" name="F_RecResults1" value="">
			<INPUT type="hidden" id="F_RecResults2" name="F_RecResults2" value="">
			<INPUT type="hidden" id="F_RecResults3" name="F_RecResults3" value="">
			<INPUT type="hidden" id="F_RecResults4" name="F_RecResults4" value="">
			<INPUT type="hidden" id="F_RecResults5" name="F_RecResults5" value="">
			<INPUT type="hidden" id="F_DelEmp1" name="F_DelEmp1" value="">
			<INPUT type="hidden" id="F_DelEmp2" name="F_DelEmp2" value="">
			<INPUT type="hidden" id="F_DelEmp3" name="F_DelEmp3" value="">
			<INPUT type="hidden" id="F_DelEmp4" name="F_DelEmp4" value="">
			<INPUT type="hidden" id="F_DelEmp5" name="F_DelEmp5" value="">
