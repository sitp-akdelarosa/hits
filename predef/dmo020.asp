...
<!--
var w=900; // Edited by AK.DELAROSA 2021/01/11
var h=870; // Edited by AK.DELAROSA 2021/01/11
if(screen.width){
        l=(screen.width-w)/2;
    }
...
function GoSijiPrint(){
  window.resizeTo(900,700); // Edited by AK.DELAROSA 2021/01/11
  target=document.dmo020F;
...
<!-- 2009/03/10 R.Shibuta Add-S -->
  <TR>
   ...
   <TD><INPUT type=text name="TruckerSubName" readonly = "readonly" value="<%=Request("TruckerName")%>" maxlength=16></TD>
