...
<head>
<title>前受け予約申請結果画面</title>
<SCRIPT LANGUAGE="JavaScript">
<!---
//--->
/* 戻るのクリック */
function ClickBack(go) {
		location.href = "SYWB062.asp?YMD=" + YMD.value + "&NAME=" + HHName.value + "&Term_Name=" + Term_Name.value
...
<br><br>
<center>
<p><img border="0" src="image/title37.gif" width="236" height="34"><p>
<table border="1">   
	<tr ALIGN=middle>
...
%>
					<tr><th width="60" bgcolor ="#40E0D0" ROWSPAN=3>搬出</th>
<%
						If sBLNo(i) = "" Then
%>
							<td width="160" bgcolor ="#cccc99">コンテナ番号</td>
...
<%
	...
	dim sText
	sText = "SYWB062.asp?YMD=" & sYMD & sHH & "&NAME=" & sHHName & "&Term_Name=" & sTerm_Name
