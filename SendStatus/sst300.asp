...
<% if F_ArrivalTime(0) = "1" or Request.Form("F_ArrivalTime(0)") = "1" then %>
		...
		<TD width="95%" colspan="2">(1)入港時間<BR>
...
<!--	<TD width="95%" colspan="2"><input type="checkbox" value="0" name="ArrivalTime">(1)入港時間</TD> -->
		<TD width="95%" colspan="2">(1)入港時間</TD>
<!--	2009/03/10 R.Shibuta Upd-E -->
<% end if %>
...
<!--	<%' end if %> -->
		<TD width="95%" colspan="2">(2)ＣＹ搬入時間</TD>
<!--	2009/03/10 R.Shibuta Upd-E -->
	</TR>
	<TR>
		<TD width="5%">　</TD>
...
<!--	<% 'end if %> -->
<!--	<TD width="95%" colspan="2"><input type="checkbox" value="1" name="List" checked>(3)通関許可状況</TD> -->
		<TD width="95%" colspan="2">(3)通関許可状況</TD>
<!--	2009/03/10 R.Shibuta Upd-S -->
	</TR>
	<TR>
		<TD width="5%">　</TD>
...
<!--<%' end if %> -->
		<TD width="95%" colspan="2">(4)ＤＯクリア状況</TD>
<!--	</TR> -->
<!--	2009/03/10 R.Shibuta Upd-E -->
	<TR>
		<TD width="5%">　</TD>
...
<!-- <%' end if %> -->
<!--	2009/03/10 R.Shibuta Upd-E -->
		<TD width="95%" colspan="2">(5)搬出可否</TD>
	</TR>
	<TR>
		<TD width="5%">　</TD>
<!--	2009/03/10 R.Shibuta Upd-S -->
...
<!-- <%' end if %> -->
		<TD width="55%">(6)デマレージフリータイム</TD>
<!--	2009/03/10 R.Shibuta Upd-E -->

<% if Request.Form("DaysToDMFT") <> "" then %>
		<TD width="50%"><input type="text" name="DaysToDemurrageFreeTime" value="<%=Request.Form("DaysToDMFT")%>" size="2" maxlength="1">日以内になったとき</TD>
<% else %>
		<TD width="50%"><input type="text" name="DaysToDemurrageFreeTime" value="<%=DaysToDMFT%>" size="2" maxlength="1">日以内になったとき</TD>
<% end if %>
	</TR>
	<TR>
		<TD width="5%">　</TD>
...
<!-- <%' end if %> -->
<!--	2009/03/10 R.Shibuta Upd-E -->
		<TD width="95%" colspan="2">(7)ＣＹ搬出時間</TD>
	</TR>
	<TR>
		<TD width="5%">　</TD>
<!--	2009/03/10 R.Shibuta Upd-S -->
...
<!-- <%' end if %> -->
<!--	2009/03/10 R.Shibuta Upd-E -->
		<TD width="45%">(8)ディテンションフリータイム</TD>
		
<% if Request.Form("DaysToDTFT") <> "" then %>
		<TD width="50%"><input type="text" name="DaysToDetentionFreeTime" value="<%=Request.Form("DaysToDTFT")%>" size="2" maxlength="1">日以内になったとき</TD>
<% else %>
		<TD width="50%"><input type="text" name="DaysToDetentionFreeTime" value="<%=DaysToDTFT%>" size="2" maxlength="1">日以内になったとき</TD>
<% end if %>
	</TR>
	<TR>
		<TD width="5%">　</TD>
		<TD width="95%" colspan="2">(9)空コン返却状況</TD>
	</TR>
	<TR>
		<TD height="5">　</TD>
	</TR>	
	<TR>
		<TD width="100%" colspan="3"><B>配信先</B></TD>
<!-- 2009/07/15 Add-S Fujiyama -->
		<TR></TR>
		<TD width="10%" colspan="1"></TD>
		<TD width="10%" colspan="2">アドレスごとに受信したい項目にチェックをつけます</TD>
