...
<CENTER>
<P><BR></P>
<P><B><Font color="#000066">表示種類切替</FONT></B></P>
<P><A HREF="JavaScript:opnewin(1)">依頼中一覧</A></P>
<P><A HREF="JavaScript:opnewin(2)">新規依頼</A></P>
<P><A HREF="JavaScript:opnewin(3)">設定</A></P>
<FORM name="sst000MF">
</FORM>
</CENTER>
<!-------------画面終わり--------------------------->
