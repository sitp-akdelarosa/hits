            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>海貨入力－輸出コンテナ情報入力</b></td>
              ...
              <table border="0" cellspacing="2" cellpadding="3">
                ...
                <tr> 
                  <td width="15"> </td>
                    <td width="575"> 
                      <dl> 
                        <dt>前述のアプリケーションを使って、コンテナNo.、シールNo.、貨物重量・・・の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                          <table border="1" cellspacing="1" cellpadding="5">
                            <tr> 
                              <td bgcolor="#FFFFFF" nowrap>A1284, 
                                B3567, 22345, 123567890, book1345, FYTU3546887, 123456, 
                                8.5, 12.8, 1, 0<br>
                                F8976, D7909, 88293, 334455666, book3746, 
                                GHKU9888700, 566543, 9.2, 14.5, 0, 0 </td>
                            </tr>
                          </table>
                          <br>
                        <dt>1行分の項目の詳細仕様<BR>
                        <dd> 
                          <table border="1" cellspacing="0" cellpadding="2" bgcolor="#FFFFFF">
                            ...
                            <tr valign="top"> 
                              ...
                              <td nowrap>半角大文字英数字12桁以内</td>
                            </tr>
                            <tr valign="top"> 
                              <td nowrap>シールNo.</td>
                              <td nowrap>123456</td>
                              <td nowrap>半角大文字英数字15桁以内</td>
                            </tr>
                            <tr valign="top"> 
                              <td nowrap>貨物重量</td>
                              <td nowrap>8.5</td>
                              <td nowrap>半角数字（単位t、小数点以下１桁）<br>
                                （'8.0'と'8'の両方の表現に対応）</td>
                            </tr>
                            <tr valign="top"> 
                              <td nowrap>総重量</td>
                              <td nowrap>12.8</td>
                            ...
                            <tr valign="top"> 
                              <td nowrap>リーファー</td>
                              <td nowrap>1</td>
                              <td nowrap>0:リーファー以外　1: リーファー</td>
                            </tr>
                            <tr valign="top"> 
                              <td nowrap>危険物</td>
                              <td nowrap>0</td>
                              <td nowrap>0:非危険品　1:危険品</td>
                            </tr>
                          </table>
                        <br>
