            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>輸出コンテナ照会結果出力（荷主用）</b></td>
                          ...
                          <tr> 
                            ...
                            <td> 
                              <table border="1" cellspacing="1" cellpadding="5">
                                <tr> 
                                  <td bgcolor="#FFFFFF" nowrap>荷主管理番号,Booking 
                                    No.,コンテナNo.,海貨,指定陸運業者,空コン受取場所,サイズ<br>
                                    6789223,ABS544423, FYTU3546887, 大山海運株式会社, 
                                    富山運送株式会社,香椎VP, 20<br>
                                    6789224,ABS544423, KYAU8981726, 株式会社犬塚高速, 
                                    ハザマ株式会社,香椎VP, 40<br>
                                    <br>
                                  </td>
                                </tr>
                          ...
                          <tr> 
                            ...
                            <td> 
                              <table border="1" bgcolor="#FFFFFF" >
                                ...
                                <tr valign="top" > 
                                  <td nowrap>6789224</td>
                                  <td nowrap>ABS544423</td>
                                  <td nowrap>KYMU8389922</td>
                                  <td nowrap> 株式会社犬塚高速</td>
                                  <td nowrap> ハザマ株式会社</td>
                                  <td nowrap>香椎VP</td>
                                  <td nowrap>40</td>
                                </tr>
                              </table>
                  ...
                  <td width="575"> 
                    <dl> 
                      ...
                      <dd> 
                        <table border="1" cellspacing="1" cellpadding="5">
                          <tr> 
                            <td bgcolor="#FFFFFF">荷主管理番号, Booking No., コンテナNo., 
                              海貨, 指定陸運業者, 空コン受取場所, サイズ, 高さ, リーファー, シールNo., 貨物重量, 
