...
<%
    ...
    ' 輸出コンテナ照会
    WriteLog fs, "1001","輸出コンテナ照会(外部)","00", ","
%>
...
<center>
      ...
      <form action="expcntnr.asp">
              <table border="1" cellspacing="1" cellpadding="3" bgcolor="#ffffff">
                ...
                <tr> 
                  <td align="center" colspan="2">あと
                  </td>
                </tr>
                <tr> 
                  <td bgcolor="#000099"><font color="#FFFFFF"><b>港コード</b></font></td>
                  <td nowrap> 
					<table border=0 cellpadding=0 cellspacing=0>
					  <tr>
						<td>
							<input type="text" name=portcode size=20 maxlength="5">
						</td>
						<td align=left valign=middle nowrap>
							<font size=1 color="#ee2200">[ 必須入力 ]</font><BR>
							<font size=1 color="#2288ff">[ 半角英数 ]</font>
