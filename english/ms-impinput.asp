...
<%
    ...
    ' 輸入陸運情報入力
    If strKind="1" Then
       strTitle="(輸入)実入りコンテナ倉庫到着時刻"
    Else
       strTitle="(輸入)デバンニング完了時刻"
    End If
    WriteLog fs, "2107","輸入コンテナ照会-デバンニング完了時刻入力","00", ","
...
%>
      ...
      <FORM NAME="con" METHOD="post" action="ms-impinput-syori.asp" onSubmit="return ClickSend()">
