          ...
          <td> 
            <table>
              <tr>
                ...
                <td nowrap><b>Vanning container information</b></td>
...
<%
    ...
    End If
%>
                <td rowspan="2" bgcolor="#FFCC33" nowrap align="center">Container No.<font size="-1"><sup>(*1)</sup></font></td>
<!-- mod by mes(2005/3/28) テアウェイト追加 -->
<!--                <td colspan="5" bgcolor="#FFCC33" nowrap align="center">空コンテナ</td>-->
 <!--                <td colspan="6" bgcolor="#FFCC33" nowrap align="center">Empty container</td> -->
		<td colspan="7" bgcolor="#FFCC33" nowrap align="center">Empty container</td>
<!-- end mes -->
                <td colspan="6" bgcolor="#FFCC33" nowrap align="center">Full Container</td>
              </tr>
              <tr> 
                <td bgcolor="#FFFF99" align="center" nowrap>Pickup <br>
                  time</td>
                <td bgcolor="#FFFF99" align="center" nowrap>Pickup place</td>
                <td bgcolor="#FFFF99" align="center" nowrap>size</td>
<!-- Add-S MES Aoyagi 2010.11.23 -->
		<td bgcolor="#FFFF99" align="center" nowrap>Type</td>
<!-- Add-E MES Aoyagi 2010.11.23 -->
                <td bgcolor="#FFFF99" align="center" nowrap>height<BR>
                  <font size="-1"><sup>(*2)</sup></font></td>
<!-- add by mes(2005/3/28) テアウェイト追加 -->
                <td bgcolor="#FFFF99" align="center" nowrap>TW</td>
<!-- end mes -->
                <td bgcolor="#FFFF99" align="center" nowrap>Reefer</td>
<!-- commented by nics 2009.03.05
                <td bgcolor="#FFFF99" align="center" nowrap>Warehouse <br>
                  arrival time</td>
end of comment by nics 2009.03.05 -->
                <td bgcolor="#FFFF99" align="center" nowrap>Seal No.</td>
                <td bgcolor="#FFFF99" align="center" nowrap>CW(t)</td>
                <td bgcolor="#FFFF99" align="center" nowrap>GW(t)</td>
                <td bgcolor="#FFFF99" align="center" nowrap>Vanning time</td>
<!-- commented by nics 2009.03.05
                <td bgcolor="#FFFF99" align="center" nowrap>Shipping<br>
                  yard</td>
end of comment by nics 2009.03.05 -->
<!-- add by nics 2009.02.24 -->
                <td bgcolor="#FFFF99" align="center" nowrap><font color="#000000">Shipping Yard<br>(code)</font></td>
                <td bgcolor="#FFFF99" align="center" nowrap><font color="#000000">Operater</font></td>
...
<form>
      <input type=button value='Display Update' OnClick="JavaScript:window.location.href='expreload.asp?request=explist2.asp'">
</form>
          </td>
        </tr>
      </table>
