      ...
      <table>
        <tr>
	     ...
	     <table>
          <tr>
	        <td nowrap>
                <center><font color="#000066" size="+1">【ターミナル入力用ファイル転送画面】</font></center><br>
			入力したい搬入確認予定時刻情報(
...
<% Else %>
	本船単位
<%  End If %>
                )を含むCSVファイルを選択し、<BR>送信ボタンをクリックして下さい。</td></tr>
		</table>
...
<%
	...
	If strChoice="bl" Then
	    WriteLog fs, "5003","ターミナル入力-CSVファイル転送(BL単位)","00", ","
	Else
	    WriteLog fs, "5005","ターミナル入力-CSVファイル転送(本船単位)","00", ","
	End If
%>
