            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>搬入確認予定時刻入力（BL単位）</b></td>
              ...
              <table border="0" cellspacing="2" cellpadding="3">
                ...
                <tr> 
                  <td width="15"> </td>
                    <td width="575"> 
                      <dl> 
                        <dt>前述のアプリケーションを使って、コールサイン、Voyage No．、処理予定時刻、BL No．の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                        <dd> 
                            ...
                            <tr> 
                              ...
                              <td> 
                                <table border="1" cellspacing="1" cellpadding="5">
                                  <tr> 
                                    <td bgcolor="#FFFFFF" nowrap>M11111, 1234E, 
                                      2002/3/12/14/50, ABS1111<br>
                                      M56678, 3456S, 2002/3/15/08/00, BBJ9876<br>
                                    </td>
                                  </tr>
                                </table>
                              </td>
