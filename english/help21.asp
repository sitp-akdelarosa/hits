            ...
            <td> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>海貨入力－輸入コンテナ情報入力</b></td>
                      ...
                      <dl> 
                        <dt>前述のアプリケーションを使って、コールサイン、Voyage No.、荷主コード・・・の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                          <table border="1" cellspacing="1" cellpadding="5" width=500>
                            <tr> 
                              <td bgcolor="#FFFFFF" nowrap><font size="1"> <font size="3">A1284, 
                                B3567, 22345, ABS1111, MESU1788239, ehk, 2002/3/12/14/5, 
                                40, SD, KCVBY<br>
                                F8976, D7909, 88293, ABS2222, MESU8832937, yeg, 
                                2002/3/18/13/45, 20, RF, GFDSH </font> </font></td>
                            </tr>
                          </table>
                          <br>
                        <dt>1行分の項目の詳細仕様<BR>
