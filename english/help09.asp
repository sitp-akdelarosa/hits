              ...
              <table border="0" cellspacing="2" cellpadding="3">
                ...
                <tr> 
                  <td width="15"> </td>
                    <td width="575"> 
                      <dl> 
                        <dt>前述のアプリケーションを使って、Booking No．、届け時刻の順にひとつひとつの値をカンマ「,」で区切りながら１行に１セットの情報を記述します。<br>
                        <dd> 
                            ...
                            <tr> 
                              ...
                              <td> 
                                <table border="1" cellspacing="1" cellpadding="5">
                                  <tr> 
                                    <td bgcolor="#FFFFFF" nowrap>ABS544423, 2002/3/12<br>
                                      JFD988222, 2002/3/12<br>
                                    </td>
                                  </tr>
                                </table>
                              </td>
