...
End of comment by seiko-denki 2003.07.18 -->
  ...
  <table>
	     ...
	     <table>
          <tr>
	        <td nowrap>
                <font color="#000066" size="+1"><center>【船社/ターミナル用ファイル転送画面】</center></font><br>
			入力したい本船情報を含むCSVファイルを選択し、送信ボタンを
              クリック<br>して下さい。</td></tr>
		</table>
			<form action="nyuryoku-csvin.asp" enctype="multipart/form-data" method="post"> 
...
<%
    ...
    WriteLog fs, "3002","船社／ターミナル入力-CSVファイル転送","00", ","
%>
