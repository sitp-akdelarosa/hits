            ...
            <td align="center"> 
              <table>
                <tr> 
                  ...
                  <td nowrap> <b><font color="#000000">ブッキング情報照会キー入力</font></b>&nbsp;&nbsp;</td>
              ...
              <table border="0" cellspacing="2" cellpadding="3">
                ...
                <tr> 
                  <td width="15"> </td>
                  <td width="575">参照したいBooking No.が多い場合、何度も入力して検索を実行するのは面倒です。<br>
                    そこで、本システムでは参照したいBooking No.を羅列したファイルを作り、そのファイルを転送してまとめて検索を行う機能を用意しています。<br>
                ...
                <tr> 
                  <td width="15"> </td>
                  <td width="575"> 
                      前述のアプリケーションを使って１行に１個のBooking No.を記述し、目的のBooking No.の数だけ行を作ります。 
                        <br>
                      ...
                      ファイル名は何でもかまいませんが、拡張子は通常「.csv」とします。保存先も自由です。<br>
