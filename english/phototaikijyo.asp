...
<%
    ...
    ' 待機場映像
    WriteLog fs, "8004", "ゲート前映像・混雑状況照会-待機場映像", "00", ","
%>
...
%>
        ...
        <table>
          <tr> 
            ...
            <td nowrap><b>待機場映像</b></td>
            <td><img src="gif/hr.gif" width="400" height="3"></td>
          </tr>
          <tr>
            <td colspan="3"><img src="camera/taiki.jpg" width="600" height="409"></td>
          </tr>
          <tr>
            <td colspan="3">
			<form>
