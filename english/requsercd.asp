...
function Check(){
  ...
  if(ret==false){
    alert("Please input company code in alphanumeric characters.");
    return false;
  }
  
  if(userid.value==""){
    alert("Compulsory Input.");
	userid.focus();
    return false;
  }
...
<table border=0><INPUT name="Gamen_Mode" size="9" readonly tabindex= -1 type= hidden>
 <tr>
	<td align=left valign=middle colspan="3"  height="50">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please input your company ID and password.<BR></td>
	
  </tr>
  <tr>
  	<td width="40">&nbsp;</td>
	<td align=left valign=middle class="kaisha">COMPANY ID</td>
	<td align=left valign=middle height="30"><INPUT type=text name="user" maxlength=5 size=15 tabindex=1></td>	
  </tr>
  <tr>
    <td>&nbsp;</td>
	<td align=left valign=middle class="kaisha">PASSWORD</td>
...
<input type=button value="   Next   " onClick="fIns()" tabindex=3>&nbsp;&nbsp;&nbsp;&nbsp;
<input type=button value="   Cancel   " onClick="fClose();" tabindex=4>
	</td>
  </tr>
</table>
</form>
