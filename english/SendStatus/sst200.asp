...
<TITLE>IMPORT DELIVERY REQUEST REGISTERATION</TITLE>
<META content="text/html; charset=Shift_JIS" http-equiv=Content-Type>
<SCRIPT src="./JS/Common.js"></SCRIPT>
<SCRIPT language=JavaScript>
<!--
function setParam(target){
	window.resizeTo(600,260);
	bgset(target);
	window.focus();
}
...
function GoNext(){
	...
	if(Number.length==0){
		alert("Input container No. or BL No.");
		f.ContBLNo.focus();
		return;
	}
...
<FORM name="sst200" method="POST">
	<TR>
		<TD colspan="3">
			<B>IMPORT DELIVERY REQUEST REGISTERATION</B><BR>
		</TD>
	</TR>
	<TR>
	...
	<TR>
		<TD colspan="3" align="center">
			<INPUT type="radio" name="ContORBL" value="1" checked>Container 　
	...
	<TR>
		<TD colspan="3" align="center">
			...
			<INPUT type="button" value="REGISTER" onClick="GoNext()">
