            ...
            <td align="center"> 
              <table>
                <tr> 
                  ...
                  <td nowrap> <b><font color="#000000">輸出コンテナ情報照会キー入力</font></b>&nbsp;&nbsp;</td>
              ...
              <table border="0" cellspacing="2" cellpadding="3">
                ...
                <tr> 
                  <td width="15"> </td>
                  <td width="575">参照したいコンテナNo.やBooking No.が多い場合、何度も入力して検索を実行するのは面倒です。<br>
                    そこで、本システムでは参照したいコンテナNo.、または、Booking No.を羅列したファイルを作り、そのファイルを転送してまとめて検索を行う機能を用意しています。<br>
                ...
                <tr> 
                  ...
                  <td width="575"> 
                    <dl> 
                      ...
                      <dd>前述のアプリケーションを使って１行に１個のコンテナNo.を記述し、目的のコンテナNo.の数だけ行を作ります。 
                        <br>
                      ...
                      <dd>ファイル名は何でもかまいませんが、拡張子は通常「.csv」とします。保存先も自由です。<br>
                        <font color="#FF0033">【例】</font>C:\MyDocument内に abcdef.csv  というファイル名で保存します。 
                        <br>
                        <br>
                      <dt><b>（２）複数のBooking No.で参照したい場合</b><br>
                      <dd>コンテナNo.の場合と同様に１行に１個のBooking No.を記述し、目的のBooking No.の数だけ行を作ります。 
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td valign="top" nowrap><font color="#FF0033">【例】</font></td>
                            <td> 
                        ...
                        <table border="1" cellspacing="0" cellpadding="3">
                          <tr> 
                            ...
                            <td bgcolor="#FFFFFF">１つのCSVファイルの中にコンテナNo.とBooking No.を混在させることはできません。 
                            </td>
                          </tr>
                        </table><br>
                    </dl>
                    ...
                    <dt> 
                      <ul>
                        <li>空欄に作成したCSVファイルのフルパスを記述します。 <br>
                          <font color="#FF0033">【例】</font>作成例の場合は「C:\MyDocument\abcdef.csv」と記述します。 
                          <br>
                        ...
                        <li>検索結果は通常の画面で表示されます。
                          ...
                          <table border="1" cellspacing="0" cellpadding="3">
                            <tr> 
                              ...
                              <td bgcolor="#FFFFFF">ファイルの作成が規則どおりできていないとシステムは内容を読み出すことができずエラーを表示します。その場合は、ファイルの内容を見直し、修正した後再度送信を行ってください。 
                              </td>
                            </tr>
                          </table>
                      </ul>
