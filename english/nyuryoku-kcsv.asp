...
End of comment by seiko-denki 2003.07.18 -->
		...
		<BR>
	     ...
	     <table>
          <tr>
	        <td nowrap>
                <center><font color="#000066" size="+1">【シールNo.・重量用ファイル転送画面】</font></center><br>
			入力したいコンテナ情報を含むCSVファイルを選択し、送信ボタンを
              クリック<br>して下さい。</td></tr>
		 </table>
			<form action="nyuryoku-kcsvin.asp" enctype="multipart/form-data" method="post"> 
...
<!-------------登録画面終わり--------------------------->
<%
    DispMenuBarBack "nyuryoku-ki.asp"
%>
</body>
</html>
...
<%
    ...
    ' 海貸用ファイル転送画面照会
    WriteLog fs, "4005","海貨入力シールNo.・重量入力-CSVファイル転送","00", ","
%>
