...
<%
    ...
    ' ゲート周辺簡易地図
    WriteLog fs, "8002", "ゲート前映像・混雑状況照会-ゲート周辺簡易地図", "00", ","
%>
...
<%
    ...
    strFileName="./camera/sam-gate.jpg"
...
<table border="0"><tr>
            <td align="left"><br>
              <br>
<center>
                <img src="gif/terminalmap.gif" width="431" height="272" usemap="#TarminalMap" border="0"> 
                <br>
                　<br>
 ...
 <tr>
  <td align="center" valign=middle>
	...
	<table border=5 cellpadding=0 cellspacing=0 bgcolor="#6666ff" bordercolor="#ffffff">
	 ...
	 <tr>
	  <td align=center valign=middle><a href="photogate.asp"><img src="camera/sam-gate.jpg" border="0" width="120" height="82"></a></td>
	 </tr>
	</table>
  ...
  <td align=center valign=middle>
	...
	<table border=5 cellpadding=0 cellspacing=0 bgcolor="#6666ff" bordercolor="#ffffff">
	 <tr>
	  <td align="center" valign=middle>
		<font color="#ffffff"><b>待機場映像</b></font>
	  </td>
	 </tr>
	 <tr>
	  <td align=center valign=middle><a href="phototaikijyo.asp"><img src="camera/sam-taiki.jpg" border="0" width="120" height="82"></a></td>
	 </tr>
	</table>
  ...
  <td align=center valign=middle>
	...
	<table border=5 cellpadding=0 cellspacing=0 bgcolor="#6666ff" bordercolor="#ffffff">
	 <tr>
	  <td align="center" valign=middle>
		<font color="#ffffff"><b>かもめ大橋映像</b></font>
	  </td>
	 </tr>
	 <tr>
	  <td align=center valign=middle><a href="photokamome.asp"><img src="camera/sam-kamome.jpg" border="0" width="120" height="82"></a></td>
	 </tr>
	</table>
...
<map name="TarminalMap"> 
  <area shape="rect" coords="307,224,414,250" href="photokamome.asp">
  <area shape="rect" coords="310,142,386,164" href="phototaikijyo.asp">
  <area shape="rect" coords="93,167,200,194" href="photogate.asp">
</map>
</body>
</html>