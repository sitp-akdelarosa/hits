...
<%
    ...
    ' かもめ大橋映像
    WriteLog fs, "8003", "ゲート前映像・混雑状況照会-かもめ大橋映像", "00", ","
%>
...
%>
        ...
        <table>
          <tr> 
            ...
            <td nowrap><b>かもめ大橋映像</b></td>
            <td><img src="gif/hr.gif" width="400" height="3"></td>
          </tr>
          <tr>
            <td colspan="3"><img src="camera/kamome.jpg" width="600" height="409"></td>
          </tr>
          <tr>
            <td colspan="3">
			<form>
