          ...
          <tr> 
            ...
            <td><img src="gif/hr.gif"></td>
				...
				<table>
					<tr>
						<td nowrap>
							<center><font color="#000066" size="+1">【CY搬入日用ファイル転送画面】</font></center><br>
							入力したいCY搬入日指示情報を含むCSVファイルを選択し、送信ボタンを
								クリック<br>して下さい。</td></tr>
				</table>
				<form action="nyuryoku-ex-csvin.asp" enctype="multipart/form-data" method="post"> 
...
<!-------------登録画面終わり--------------------------->
<%
    DispMenuBarBack "nyuryoku-ex.asp"
%>
</body>
</html>
...
<%
    ...
    ' 海貸用ファイル転送画面照会
    WriteLog fs, "4006","海貨入力CY搬入日-CSVファイル転送","00", ","
%>
