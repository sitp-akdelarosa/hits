...
<%
    If Not bDispMode  or USER <> "" Then
        Response.Write "<td rowspan='3' valign='middle' nowrap align='center' bgcolor='#FFCC33'>フリー<br>タイム</td>"
    End If
%>
<!-- mod by nics 2010.02.16 -->
...
<% ' 搬出ターミナル(蔵置場所コード)
    ...
    If anyTmp(5) <> "" Then
        strDisp = anyTmp(5)
'' 2009/11/01 del-s 蔵置場所コードを削除
        If anyTmp(43) <> "" Then
            strDisp = strDisp & "<br>(" & anyTmp(43) & ")"
        End If
'' 2009/11/01 del-e 蔵置場所コードを削除
    End If
    Response.Write strDisp
%>
                     </td>
