            ...
            <td align="center"> 
              <table>
                <tr> 
                  ...
                  <td nowrap><b>輸出コンテナ情報照会結果出力（複数コンテナ）</b></td>
                          ...
                          <tr> 
                            ...
                            <td> 
                              <table border="1" cellspacing="1" cellpadding="5">
                                <tr> 
                                  <td bgcolor="#FFFFFF" nowrap>Booking No.,コンテナNo.,空コン受取場所,サイズ<br>
                                    ABS544423, FYTU3546887, 香椎VP, 20<br>
                                    KNB738890, AGTU3847382, 香椎VP, 40<br>
                                  </td>
                                </tr>
                              </table>
                            </td>
                    ...
                    <dl> 
                      ...
                      <dd> 
                        <table border="1" cellspacing="1" cellpadding="5" width=500>
                          <tr> 
                            <td bgcolor="#FFFFFF">Booking No., コンテナNo., 空コン受取場所, サイズ, 高さ, リーファー, シールNo., 貨物重量, 総重量, 搬入ターミナル名, CYオープン日, CYクローズ日,
									空コン受取完了時刻, 倉庫到着指示時刻, 倉庫到着完了時刻, バンニング完了時刻, SY予約時刻, SY搬入完了時刻, CY搬入指示日,
									CY搬入完了時刻, 船積完了時刻, 離岸計画時刻, 離岸予定時刻, 離岸完了時刻, 仕向港着岸予定時刻, 仕向港着岸完了時刻, 船社, 船名,
									VoyageNo., 仕向港, 危険品
							</td>
                          </tr>
                        </table>
                      ...
                      <dd> 
                        <table border="1" cellspacing="0" cellpadding="3">
                          <tr> 
                            ...
                            <td bgcolor="#FFFFFF">Booking No.はBooking No.で照会された場合のみ出力されます。 
                            </td>
                          </tr>
                        </table>
                        <br>
