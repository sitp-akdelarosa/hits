...
<!-- Add-E MES Aoyagi 2010.11.23 -->
                ...
                <td nowrap bgcolor="#FFFFCC" align="center" rowspan="2">リーファ</td>
...
<!-- commented by nics 2009.02.24
                ...
                <td nowrap bgcolor="#FFFFCC" colspan="2">搬出時刻</td>
<!-- commented by nics 2009.02.24
...
<!-- add by nics 2009.02.24 -->
<!-- mod by nics 2010.02.16 -->
<!--                <td nowrap bgcolor="#FFFFCC" rowspan="2">ディテンション<br>フリータイム</td>	-->
<%
    If Not bDispMode  or USER <> "" Then
        Response.Write "<td nowrap bgcolor='#FFFFCC' rowspan='2'>"
        Response.Write "ディテンション<br>フリータイム</td>"
    End If
%>
