...
function Calendar() {
	...
	this.daysOfWeek = "“ú ŒŽ ‰Î … –Ø ‹à “y".split(" ");
	this.months = "1ŒŽ 2ŒŽ 3ŒŽ 4ŒŽ 5ŒŽ 6ŒŽ 7ŒŽ 8ŒŽ 9ŒŽ 10ŒŽ 11ŒŽ 12ŒŽ".split(" ");
...
Calendar.prototype.buildString = function(){
	...
	tmpStr += '<thead><tr><td colspan="7"><ul>\n'+
			...
			'<ul id="cp_months"><li><a href="javascript:g_Calendar.clickMonth(0)">1ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(1)">2ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(2)">3ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(3)">4ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(4)">5ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(5)">6ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(6)">7ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(7)">8ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(8)">9ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(9)">10ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(10)">11ŒŽ</a></li><li><a href="javascript:g_Calendar.clickMonth(11)">12ŒŽ</a></li></ul></li>\n' +
			...
			'<li id="cp_yearMenu"><a href="javascript:g_Calendar.openMenuYears();" title="Open years menu">' + this.year + '”N' + '</a>\n';
	...
	tmpStr += '</tr></thead><tfoot><tr><td colspan="7">Today is: <a href="javascript:g_Calendar.clickToday()" title="Go to current month">' + (/^d/.test(this.dateFormat)?dtToday.getDate() + ' ' + this.months[dtToday.getMonth()] + ' ':dtToday.getFullYear() + '”N' + this.months[dtToday.getMonth()] + '') + dtToday.getDate()+'“ú'+'</a></td></tr></tfoot><tbody>';
