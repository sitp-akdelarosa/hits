...
'2017/04/05 H.Yoshikawa メニュー(11)「確定事業者マスタメンテナンス」追加
'***********************************************************
Option Explicit
Response.Expires = 0
				   ...
				   <table width=100%>	                
					...
					<tr>
					  ...
					  <table border="0" cellspacing="2" cellpadding="3">
						...
						<!-- 2017/04/05 H.Yoshikawa add start -->
						<tr> 
						  <td nowrap align=left valign=middle><a href="deftrade.asp">（11）確定事業者マスタメンテナンス</a></td>
						</tr>
						<!-- 2017/04/05 H.Yoshikawa add end -->
					  </table>	
					  </center>				  					  
					</td>
				   </tr>
