...
<BODY leftMargin=0 topMargin=0 marginheight="0" marginwidth="0" onLoad="finit();" style="background-color:#e6e6fa;">
<form name="frm" method="post">
<INPUT type=hidden name="Gamen_Mode" size="9" readonly tabindex= -1>
<table border=0 cellPadding=1 cellSpacing=0 width="100%">
<tr>
<td>
<TABLE border=0 cellPadding=0 cellSpacing=0 style="position:relative; left:30px; top:20px;">
  <% If Trim(ActionType) = "D" Then%>
  <tr>
  <td colspan=2>
