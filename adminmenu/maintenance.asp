...
function LfSendMail()
	...
	elseif v_SendFlag = "9" then
		sql = "Select MailAddress from mUsers WHERE (MailSend IS NOT NULL AND MailSend='9') AND (MailAddress IS NOT NULL AND MailAddress <> '')"
	else
