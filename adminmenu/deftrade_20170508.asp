...
function LfSearchData()
	...
	if v_SDefCode <> "" then
		...
		sql = sql & " WHERE DefCode = '" & gfSQLEncode(v_SDefCode) & "'"
							...
							<tr>
							  <td align="left" width="100%"> 						
								  <table width="100%" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
									  ...
									  <td>
										  ...
										  <td>
											  ...
											  <td>
												<input type="text" name="SDefCode" size="15" maxlength="12" value="<%=gfHTMLEncode(v_SDefCode)%>">
											  </td>
											  </tr>
											  </table>
										  </td>
									...
									<tr>
										<td></td>
										<td colspan="3" style="font-size:12px;">※登録番号は、ハイフンなしで入力してください。</td>										
									</tr>
									<tr>
										<td height="10"></td>										
									</tr>									
									<tr>
									  ...
									  <table border="0" cellspacing="0" cellPadding="0">
										<tr>											
											<th width="93" class="menutitle">登録番号</th>
											<th width="345" class="menutitle">確定事業者</th>																						
										</tr>										
									  </table>									
									  </td>									  
									 </tr>
									 <tr>
										<td>&nbsp;</td>	
										<td colspan="3">		
											<div style="width:470px;height:300px; overflow-y:scroll;">
											<table border="0" cellspacing=0 cellPadding=0>																														
											<% for i=1 to UBOUND(Arr_DefCode) %>
												<tr>																						
													<% v_ItemName = "DefCode" + cstr(i) %>
													<td class="data2">
													<input type="text" name="<%= v_ItemName %>" size="15" maxlength="12" value="<%=Arr_DefCode(i)%>" onFocus="document.frm.<%= v_ItemName %>.select();" style="ime-mode: disabled;">
													</td>
													<% v_ItemName = "DefName" + cstr(i) %>
													<td class="data2">
													<input type="text" name="<%= v_ItemName %>" size="60" maxlength="50" value="<%=Arr_DefName(i)%>" onFocus="document.frm.<%= v_ItemName %>.select();" style="ime-mode: auto;">														
													</td>	 
												</tr>	
											<% next %>
											</table>
