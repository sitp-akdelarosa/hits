...
Select Case  str_left_menu
	...
	Case "3"
		ReDim FieldKey(17)	
		FieldKey=Array("入力日","指示元 － コード","ブッキング番号","ピック済","SZ","タイプ","高さ","材質","船社","船名","CYカット日","空コン搬出先","指示先","指示先回答","備考１","備考２","担当")	
 	Case "4"
		ReDim FieldKey(20)
	...
	Case "5"		
		ReDim FieldKey(13)
		FieldKey=Array("入力日","指示元","指示元担当者","指示元回答","ブッキング番号","ピック済み本数","サイズ","タイプ","高さ","材質","船社","船名","指示先","指示先回答")	
	Case "6"
		ReDim FieldKey(12)
		FieldKey=Array("搬出入予定日","指示元","指示元へ回答","作業番号","コンテナ番号/BL番号","船社","船名","サイズ","搬入元/搬出先","CY","搬出可否","フリータイム","CYカット日")
...
function Sorting(){
	...
	if ("<%=str_left_menu%>" == "1" || "<%=str_left_menu%>" == "4")  
	{
