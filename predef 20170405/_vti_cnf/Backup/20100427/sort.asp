...
Select Case  str_left_menu
	...
	Case "5"		
		'2010/04/26 Upd-S C.Pestano
		ReDim FieldKey(13)
		FieldKey=Array("入力日","指示元","指示元担当者","指示元回答","ブッキング番号","ピック済み本数","SZ","タイプ","H","材質","船社","船名","指示先","指示先回答")	
		'2010/04/26 Upd-E C.Pestano
	Case "6"
		ReDim FieldKey(12)
		FieldKey=Array("搬出入予定日","指示元","指示元へ回答","作業番号","コンテナ番号/BL番号","船社","船名","SZ","搬入元/搬出先","CY","搬出可否","フリータイム","CYカット日")
