...
getSort = str
	if Key <> "" then
		...
		if str = "" then
			...
			if SortKey="ASC" Then
				getSort = " ORDER BY " & ChangeSortItem(FieldName(Key),0) & " " & SortKey
			Else
				getSort = " ORDER BY " & ChangeSortItem(FieldName(Key),1) & " " & SortKey
			End If
			...
			if SortKey="ASC" Then
				getSort = str & " , " & ChangeSortItem(FieldName(Key),0) & " " & SortKey
			Else
				getSort = str & " , " & ChangeSortItem(FieldName(Key),1) & " " & SortKey
			End If
		end if	
	end if	
end function
