...
'  DtTbl(0)=Array("入力日","搬入<BR>予定日","指示元","作業番号","ブッキング番号","コンテナ番号","完了日時","指示先","指示先<BR>回答","照会先Frag","指示元へ回答","船社","船名","SZ","H","搬入元","CY","CYカット日","備考１","備考２","備考３","備考４","TW")
  DtTbl(0)=Array("入力日","搬入<BR>予定日","指示元<BR>コード","作業<BR>番号","ブッキング番号","コンテナ番号","完了日時","指示先","指示先<BR>回答","照会先Frag","指示元へ回答","船社","船名","SZ","H","搬入元","CY","CY<BR>カット日","備考１","備考２","備考３","備考４","TW","コード","指示元<BR>担当")
