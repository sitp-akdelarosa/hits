	...
	<TABLE border=0 cellPadding=2 cellSpacing=0 width="100%">
	  ...
	  <TR>
	    ...
	    <TD><!-- 2016/08/01 H.Yoshikawa Delete 
	        ...
	        <% if Mord="0" then%>
	        <INPUT type=text name="CONtear" value="<%=TareWeight%>" maxlength=4 size=7>kg
	        <% else %>
	        <INPUT type=text name="CONtear" value="<%=Request("CONtear")%>" maxlength=4 size=7>kg		
	        <% end if %>
	        <!--  2017/03/02 T.Okui Upd-E-->
	    </TD>
	  </TR>
	  ...
	  <TR>
	    ...
	    <TD><INPUT type=text name="ReportNo" value="<%=Request("ReportNo")%>" size=17 maxlength=12 title="荷送人の届出番号、または登録確定事業者番号を入力してください。">　<span style="color:red">※ハイフンなしで入力してください</span></TD></TR>
...
<!--2017/02/06 T.Okui Del End-->
	    ...
	    <% If Mord<>"0" Then %>
	      <TABLE border=1 cellPadding=3 cellSpacing=0 align="left" style="position:relative;left:-6px;">
