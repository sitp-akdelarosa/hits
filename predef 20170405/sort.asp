...
Select Case  str_left_menu
	Case "1"
		ReDim FieldKey(18)
		FieldKey=Array("搬出予定日","指示元 － コード","作業番号","指定種類","コンテナ番号/BL番号","船社","船名","SZ","CY","フリータイム","納入先１","完了日時","返却予定","返却","指示先","指示先回答","備考１","備考２","指示元担当")
	Case "2"
		ReDim FieldKey(12)
		FieldKey=Array("搬入予定日","指示元 － コード","コンテナ番号","船社","船名","SZ","返却先","ディテンションフリータイム","指示先","指示先回答","備考","指示元担当")	
	Case "3"
		'2010/04/26 Upd-S C.Pestano
		ReDim FieldKey(17)	
		FieldKey=Array("入力日","指示元 － コード","ブッキング番号","ピック済","SZ","タイプ","H","材質","船社","船名","CYカット日","空コン搬出先","指示先","指示先回答","備考１","備考２","指示元担当")	
		'2010/04/26 Upd-E C.Pestano
 	Case "4"
		ReDim FieldKey(20)
		FieldKey=Array("搬入予定日","指示元 － コード","作業番号","ブッキング番号","コンテナ番号","船社","船名","SZ","H","TW","搬入元","CY","CYカット日","完了日時","指示先","指示先回答","備考１","備考２","備考３","指示元担当")
	...
	Case "6"
		...
		ReDim FieldKey(14) 
		FieldKey=Array("搬出入予定日","指示元","指示元へ回答","作業番号","コンテナ番号/BL番号","船社","船名","SZ","搬入元/搬出先","CY","搬出許可日","フリータイム","CYカット日","指示先","指示先回答")
