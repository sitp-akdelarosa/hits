...
'☆☆☆
            Do While strBLNo <> ""
                ...
                Else
                    ...
                    strBLNo = ""
                End If
' 2009/05/14 mod-s mes SQLインジェクション対応
...
'                bWriteFile = bWriteFile + SerchImpCntnr(conn, rsd, ti, sWhere)
                ...
                If bRtn Then
                    ...
                    bWriteFile = bWriteFile + SerchImpCntnr(conn, rsd, ti, sWhere)
                End If
' 2009/05/14 mod-e mes SQLインジェクション対応
            Loop
...
'☆☆☆ Del_E  by nics 200902改造
    ...
    ' 輸入コンテナ照会
    WriteLog fs, "2001","輸入コンテナ照会",iWrkNum, strOption
